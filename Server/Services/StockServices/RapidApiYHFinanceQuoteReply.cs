...
namespace Server.Services.StockServices
{
    ...
    public class RapidApiYHFinanceQuoteReply
    {
        public RapidApiYHFinanceQuoteResponse quoteResponse { get; set; }
    }


    public class RapidApiYHFinanceQuoteResponse
    {
        public List<RapidApiYHFinanceResult> result { get; set; }
        public string error { get; set; }
    }

    //TODO: Some fields might be wrong, price should work at least
    public class RapidApiYHFinanceResult
    {
