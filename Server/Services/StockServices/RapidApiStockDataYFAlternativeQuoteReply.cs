...
namespace Server.Services.StockServices
{
    ...
    public class RapidApiStockDataYFAlternativeQuoteReply
    {
        public RapidApiStockDataYFAlternativeQuoteResponse quoteResponse { get; set; }
    }


    public class RapidApiStockDataYFAlternativeQuoteResponse
    {
        public List<RapidApiStockDataYFAlternativeResult> result { get; set; }
        public string error { get; set; }
    }


    public class RapidApiStockDataYFAlternativeResult
    {
